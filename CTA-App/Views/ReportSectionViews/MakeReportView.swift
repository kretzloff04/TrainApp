            ...
            ZStack{
                ...
                VStack{
                    ...
                    ZStack{
                        ...
                        NavigationLink(destination: ReportDescriptionView(listOfStops: listOfStops, tag: "Smoking", lineColor: lineColor)){
                            Text("Report Smoking")
                                .frame(width: 300, height: 50)
                    ...
                    ZStack{
                        RoundedRectangle(cornerRadius: 10)
                            .stroke(Color(lineColor), lineWidth: 2)
                            .frame(width: 300, height: 50)
                        NavigationLink(destination: ReportDescriptionView(listOfStops: listOfStops, tag: "Loud Disruptions", lineColor: lineColor)){
                    ...
                    ZStack{
                        RoundedRectangle(cornerRadius: 10)
                            .stroke(Color(lineColor), lineWidth: 2)
                            .frame(width: 300, height: 50)
                        NavigationLink(destination: ReportDescriptionView(listOfStops: listOfStops, tag: "Physical Altercation", lineColor: lineColor)){
                    ...
                    ZStack{
                        RoundedRectangle(cornerRadius: 10)
                            .stroke(Color(lineColor), lineWidth: 2)
                            .frame(width: 300, height: 50)
                        NavigationLink(destination: ReportDescriptionView(listOfStops: listOfStops, tag: "Other", lineColor: lineColor)){
                            Text("Report Other")
                                .frame(width: 300, height: 50)
                                .foregroundColor(Color.black)
                                .background(Color("customReportGrey"))
...
#Preview {
    MakeReportView(lineColor: Color("customRed"), stopsImage: Image("purpleLineStops"), listOfStops: StopsData.listOfBlue)
}
